...
def doit():
  ...
  d_train = np.load('mnist_data/X_phi_train_mpp_15_theta_2_gamma_0.5_7-19-14-46.npz')
  X = d_train['arr_0']
  ...
  d_test = np.load('mnist_data/X_phi_test_mpp_15_theta_2_gamma_0.5_7-19-14-49.npz')
  X_test = d_test['arr_0']
